...
%%
musPre=mean(muFiringPre,2);
musStim=mean(muFiringStim,2);
musPost=mean(muFiringPost,2);

% ch=2;
% hold on
% plot(muFiringPre(ch,:),'k');
% plot(muFiringStim(ch,:),'b');
% plot(muFiringPost(ch,:),'m');
